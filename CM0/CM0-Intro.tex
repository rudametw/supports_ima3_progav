...
\begin{frame}
	...
	\begin{itemize}
		...
		\item J'ai un accent…
		\item Je me trompe beaucoup en français
		\begin{itemize}
			\item (et en info, et en math, et ...)
			\item N’hésitez pas à me corriger ou à me demander de répéter
		\end{itemize}
		\item Je commence à enseigner
		\begin{itemize}
			\item J'accepte des critiques (constructifs) et surtout des recommandations
...
\begin{frame}
	\frametitle{Remarque}
	\Large Ce cours est très très très largement inspirés (i.e., copié) de ceux de Nathalie Devesa (MdC Polytech'Lille), qui à son tour s'est inspiré de Bernard Carré et de Laure Gonnord.
\end{frame}
...
%	\captionof{listing}{Output of size\_ofs.c}
	\vspace{-0.5cm} \center \small  Output of \texttt{size\_ofs.c}
\end{frame}
...
void main() {   
  int*    x;  // Allouer les pointeurs en mémoire 
