...
%\documentclass[final, pdftex, a4paper, openbib, ]{article} %careful breaks lualatex
\documentclass[final, a4paper, openbib, ]{article} %careful breaks lualatex
...
%\usepackage{a4wide} %obsolete
\usepackage{upquote,textcomp}
\usepackage{geometry}
%\usepackage{hyperref}
\usepackage[
%pdftex,   %careful breaks lualatex
...
\geometry{a4paper, portrait, margin=1.85cm}
...
%\author{\huge \textbf{TP9 Un peu de généricité}\\
