...
\newcommand{\codes}{../codes/TP6_biblio_listes_chainees}
...
\begin{enumerate}
	...
	\item Observer le contenu des binaires \texttt{tp6.o} et \texttt{listechaines.o} à l'aide de la commande \texttt{nm}
...
%		\caption{\texttt{listechaines.h}}
		{c}{\codes/accompttp.c}
		\caption{Fichier d'accompagnement \texttt{accompttp.c}}		
	\end{minipage}
\end{figure}
\end{document}