...
%	\tikzstyle{block} = [draw, fill=orange!40, rectangle, minimum height=\sz, minimum width=\sz ];
	...
	\tikzstyle{rectLight} = [draw, fill=orange!15, rectangle, minimum height=\sz, minimum width=\szwidth ];
	\tikzstyle{rect2} = [draw, fill=orange!40, rectangle, minimum height=\sz, minimum width=\szwidth*3 ];
	\tikzstyle{rect3} = [draw, fill=orange!08, rectangle, minimum height=\sz, minimum width=\szwidth*3 ];
...
%	\node[plain] { x };
	...
	\node[rect3] at (6*\szwidth,\offset) {  };
	\node[rectLight] (last) at (8*\szwidth,\offset) {  };	
